...
import (
	...
	schema "github.com/answerdev/answer/internal/schema"
...
func (m *MockSiteInfoCommonService) FormatAvatar(ctx context.Context, originalAvatarData, email string) *schema.AvatarInfo {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FormatAvatar", ctx, originalAvatarData, email)
	ret0, _ := ret[0].(*schema.AvatarInfo)
	return ret0
}

// FormatAvatar indicates an expected call of FormatAvatar.
func (mr *MockSiteInfoCommonServiceMockRecorder) FormatAvatar(ctx, originalAvatarData, email interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FormatAvatar", reflect.TypeOf((*MockSiteInfoCommonService)(nil).FormatAvatar), ctx, originalAvatarData, email)
}
